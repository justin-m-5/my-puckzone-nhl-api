...
export async function getGameSummary(gameId: number): Promise<NHLApiGameSummaryLanding> {
    return fetchJsonWithRetries<NHLApiGameSummaryLanding>(`${BASE}/gamecenter/${gameId}/landing`);
}