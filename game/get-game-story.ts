...
export async function getGameStory(gameId: number): Promise<NHLApiGameStoryResponse> {
    return fetchJsonWithRetries<NHLApiGameStoryResponse>(`${BASE}/wsc/game-story/${gameId}`);
}