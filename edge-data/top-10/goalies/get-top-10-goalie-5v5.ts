...
export async function getTop10Goalie5v5({ sort = "save-pctg", seasonId, gameTypeId }: GetTop10Goalie5v5Params): Promise<Goalie5v5Entry[]> {
    const url = `${BASE}/goalie-5v5-top-10/${sort}/${seasonId}/${gameTypeId}`;
    return fetchJsonWithRetries<Goalie5v5Entry[]>(url);
}